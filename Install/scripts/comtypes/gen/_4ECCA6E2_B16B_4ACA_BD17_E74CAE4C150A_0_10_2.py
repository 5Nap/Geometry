# -*- coding: mbcs -*-
typelib_path = u'C:\\Program Files (x86)\\ArcGIS\\Desktop10.2\\com\\esriSystemUI.olb'
...
__all__ = [ 'esriSystemMouseCursorDefault',
           'esriSystemMouseCursorPagePanning', 'esriArcGISUriBase',
           'esriCommandStyles', 'ICompletionNotify',
           'esriCommandStyleIconAndText', 'CommandHost',
           'IArcGISSingleSignon2', 'esriKeyIntercept', 'IMultiItemEx',
           'esriSystemMouseCursorHotLink', 'IArcGISSingleSignon',
           'esriArcGISUriNewAccount', 'esriSystemMouseCursorPagePan',
           'esriArcGISUriPing', 'esriSystemMouseCursorSizeNS',
           'esriSystemMouseCursorZoomIn', 'esriArcGISUriUpdate',
           'esriCommandStyleIconOnly', 'esriSystemMouseCursorZoomOut',
           'ISystemMouseCursor', 'esriSystemMouseCursorPanning',
           'IToolPalette', 'IOperationStack',
           ...
           'IComboBox', 'esriTipStyleSolid',
           'esriSystemMouseCursorIcon',
           'esriSystemMouseCursorSizeNWSE', 'IArcGISPortal',
           'ArcGISSingleSignon', 'esriArcGISGlobeBasemapQuery',
           'ITool', 'esriKeyInterceptTab', 'esriSystemMouseCursor',
           ...
           'esriSystemMouseCursorHand', 'SystemFont',
           'esriSystemMouseCursorPageZoomOut',
           'esriSystemMouseCursorPencil', 'esriCmdBarTypeMenu',
           'IDataObjectHelper', 'esriSystemMouseCursorNoDrop',
           'ICommandHost', 'esriSystemMouseCursorLabel', 'IMultiItem',
           'IToolControl', 'IComPropertySheetEvents',
           'esriCommandStyleMenuBar', 'esriCmdBarTypeToolbar',
           'esriSystemMouseCursorHourglass', 'esriCmdBarType',
           ...
           'esriTipStyleTransparent', 'esriSystemMouseCursorIdentify',
           'IToolBarDef', 'esriArcGISUri',
           'esriSystemMouseCursorSizeAll',
           'esriKeyInterceptArrowKeys', 'esriSystemMouseCursorArrow',
           'ICommandSubType', 'esriSystemMouseCursorUpArrow',
           'esriArcGISUriSecure', 'ICommand', 'IOperation',
           'IProgressDialog', 'IPaletteDef',
