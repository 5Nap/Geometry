...
__all__ = [ 'IItemIndex3', 'IItemIndex2', 'IDataSourceConfiguration2',
           ...
           'GPItemInfoHelper', 'IIndexingStatus', 'ISearchServer',
           'esriDataSourceTypeServer',
           'esriIndexingTypeFirstTimeFull',
           'esriDataSourceTypeDatabase', 'SearchServerIP',
           'IDSCStatusArray', 'SearchConfiguration',
           ...
           'DSCStatusArray', 'ItemIndex', 'IItemIndex',
           'IndexingConfiguration', 'esriDataSourceType',
           'ISearchServerAdmin', 'IGPMultithreadedItemIndexer',
           'IItemIndexer', 'SearchServerConfigurationFactory',
           'IGPItemIndexer2', 'IDataSourceConfiguration']
