# -*- coding: mbcs -*-
typelib_path = u'C:\\Program Files (x86)\\ArcGIS\\Desktop10.2\\com\\esriDataSourcesNetCDF.olb'
...
__all__ = [ 'IMDRasterDatasetView', 'E_NETCDF_FILE_NOT_FOUND',
           'E_NETCDF_RENDERER_INVALID_BAND_INDEX', 'NetCDFTableName',
           'NetCDFWorkspaceFactory', 'E_NETCDF_UNKNOWN_ERROR',
           'E_NETCDF_FILE_FAILED_TO_COPY',
           'E_NETCDF_FILE_INVALID_EXTENSION', 'IMDDatasetView',
           'esriNetCDFError', 'NetCDFRasterDatasetName',
           'IMDTableView', 'E_NETCDF_DATASET_EXIST',
           'NetCDFWorkspace', 'IMDFeatureClassView',
           'INetCDFWorkspace', 'NetCDFFeatureClassName',
           'E_NETCDF_ACCESS_IS_DENIED',
           'E_NETCDF_FILE_FAILED_TO_RENAME',
           'IProtectNamesDataSourcesNetCDF', 'IMDWorkspace']
