# -*- coding: mbcs -*-
typelib_path = u'C:\\Program Files (x86)\\ArcGIS\\Desktop10.2\\com\\esriArcMapUI.olb'
...
__all__ = [ 'TableContextMenuArrangeItems', 'IMxApplication',
           'RemoveLayersOperation', 'IDocumentDefaultSymbols',
           'OverviewWindowFactory', 'ITableProperty3',
           'GenericWindow', 'ITableProperties',
           'ILayerEffectsEnvironment3', 'esriMxFillColor',
           'AddDataDialog', 'RasterCatalogGxBrowserFactory',
           'IDissolveUIAdmin', 'IBasicDocument',
           'LasDatasetGxBrowserFactory', 'IFindWindow', 'IJoinData',
           'ExcludeUnselectedFeaturesCommand', 'TOCDockableWindow',
           'ITableWindow', 'ITableProperty',
           'MapServerLayerSourcePropertyPage', 'IStartupDialog2',
           'IStartupDialog3', 'TOCCatalogView',
           'esriTerrainPointAttributeHisto',
           'esriCEShowDataFrameProperties', 'IChangeLayout',
           'MetaFileClipboardFormat', 'RasterLayerContextAnalyzer',
           'JoinData', 'AnnotateSelectedFeatures',
           'PageIndexGeneralPropPage', 'esriLasPointElevationHisto',
           'ITableWindow2', 'IMSPropsPropertyPage',
           'esriTinElevationHisto', 'esriCEShowLayersProperties',
           'ColorCorrectionWindowCommand', 'IReportUnitFormat',
           'esriDCTable', 'IDataWindow2', 'GettingStartedSettings',
           'MapPropertyPage', 'esriMxDlgStyleGallery', 'IJoinData2',
           'MapServerLayerAdvancedPropertyPage', 'SpatialJoin',
           'IStartupDialogSettings', 'IFindPanelEvents',
           'SelectByCommonValueTool', 'esriMxDlgIDs',
           'DataConnectionPropertyPage', 'ILayerEffectsEnvironment',
           'FindWindowUI', 'TimeSliderWindowCommand',
           'TOCDisplayView', 'ILensWindow',
           'WMSLayerSourcePropertyPage', 'IContentsViewEdit',
           'IDissolveUI', 'AVImageThemeImporter', 'MapInsetWindow',
           'LasDatasetIdentifyObject', 'GroupLayerContextAnalyzer',
           'ITableDockWindowAdmin', 'IMoveLayersOperation',
           'esriMxLineColor', 'IClipboardFormat2',
           'UngroupLayerOperation', 'DataGraphMxDocumentDropTarget',
           'IBasicDocument2', 'IFindWindow2', 'OverviewPropertyPage',
           'IMetadataViewWindow3', 'IMetadataViewWindow2',
           'IAddDataDialog2', 'TinGxBrowserFactory',
           'ReferenceScaleOperation', 'IPageIndexControl',
           'IMSLayersPropertyPage', 'MoveLayersOperation',
           'IMxApplication3', 'IBasicDocumentDefaultSymbols',
           'IMSLayerFactory', 'ImageInsetWindow',
           'PublishOptionsPage', 'IModelessQueryAttributes',
           'IMSFeatureLayerSymbology', 'TinHistogram',
           'IDataGraphTWizard', 'WMSMapLayerFactory',
           'NetCDFTablePropertyPage', 'IGpsPositionDialog',
           'IEnumTableProperties', 'IDocumentEvents',
           'esriMxDlgOptions', 'MxDocument', 'esriMxDlgPageSetup',
           'IDataConnectionPropertyPage', 'DataViewPropertyPage',
           'IDataConnectionCallback', 'RotateOperation',
           'ISelectFeaturesOperation', 'RasterToolsDockWin',
           'IAnnotateFeaturesCallback', 'IRasterDockWin',
           'ProgressAnimation', 'esriMxDefaultColorTypes',
           'IGpsExtension', 'esriMxDlgMacros',
           'IDataConnectionCallback2', 'GNetExtension',
           'IDataWindowFactory', 'IReportUnitFormat2',
           'ITinHistogram', 'IRelateData',
           ...
           'ProgressDialog', 'IGenericWindow',
           'TableContextMenuArrange', 'QueryAttributes',
           'GpsLogFilter', 'ReportSelection', 'IdentifyWindowCommand',
           'PixelInspectionDockWin', 'IRemoveLayersOperation',
           'RasterToolExtension', 'RasterTableShowMultiItem',
           'MapIlluminationPropertyPage', 'LayerSelectionContextMenu',
           'IClipboardFormat', 'TextClipboardFormat',
           'IMxDocumentDropTarget', 'esriTinHistogramType',
           'esriDCDataFile', 'WMSLayerAdvancedPropertyPage',
           'esriDCFeatureClass', 'IApplicationWindows',
           'esriMxDlgCustomize', 'LayoutViewPropertyPage',
           'IOverviewWindow', 'MapInsetWindowFactory',
           'IContentsView', 'IDocumentEventsDisp',
           'GNetCommandHandler', 'Maps', 'NewDocumentDialog',
           'IEnumPrinterNames', 'TOCPatchesPropertyPage',
           'IMxApplication2', 'MapGridsPropertyPage',
           'TableProperties', 'MoveMapsOperation', 'JoinRelatePage',
           'IReferenceScaleOperation', 'IMxDocument', 'MxStatusBar',
           'OpenTableCommand', 'IViewCommand',
           'BasemapSubLayerRasterLayerContextAnalyzer',
           'IDatasetFilter', 'ITableFrame', 'ElementSelection',
           'IPixelInspectionWindow', 'TOCLegendSelectionView',
           'IMetadataViewWindow', 'TableDockWindow',
           'RasterBasemapLayerContextAnalyzer',
           'MapViewCommandsContextMenu', 'IContentsView2',
           'IContentsView3', 'RemoveLayerOperation',
           'LayersClipboardFormat', 'SelectFeaturesOperation',
           'MensurationDockWin', 'esriTinAspectHisto',
           'IFindCallBack', 'LayerEffectsEnvironment',
           'RestoreExcludedFeaturesCommand',
           'TerrainGxBrowserFactory', 'PageIndexExtentPropPage',
           'IHistoryViewerWindow', 'IDataGraphWindow2', 'TableWindow',
           'IUngroupLayerOperation',
           'ImageServerLayerContextAnalyzer', 'esriMxDlgContents',
           'IDataWindow', 'IDataWindowEvents', 'IAddDataDialog',
           'IGNetExtension', 'IRemoveLayerOperation2',
           'AddLayersOperation', 'HistoryViewerWindow',
           'ElementNewOperation', 'MapViewerWindowFactory',
           'TOCGeneralPropertyPage', 'esriDCRasterCatalog',
           'esriMxDlgVBA', 'IRelateData2', 'IMensurationResult',
           'IRemoveLayerOperation', 'IJoinPages',
           'TOCLegendDisplayView', 'ISpatialJoin',
           'IContentsViewSelection', 'MapServerSublayersPropertyPage',
           'IViewCommandToolbars', 'esriMxDlgProperties',
           'esriMxDlgZoom', 'IMoveMapsOperation',
           'MosaicDatasetExtension', 'IGroupLayersOperation',
           'WMSIdentifyObject', 'TemplateStartupDialog',
           'esriMxDlgUnlockCustomization', 'AppDisplay',
           'DataGraphTWizard', 'IDataConnectionPropertyPage2',
           'IMSSubLayerContextAnalyzer', 'DocumentEvents',
           'PublishDestinationPage', 'DocumentPropertyPage',
           'PublishAntiAliasingPage', 'IAnnotateSelectedFeatures',
           'OverviewWindow', 'INewDocumentDialog', 'OleFrame',
           'NetworkLayerFactory', 'ITableWindow3', 'IFinder',
           'GettingStartedWindow', 'ProgressBar', 'IAggregateOptions',
           'esriMxDlgPrintSetup', 'GpsExtension',
           'ImageAnalysisWindowCommand', 'MapServerIdentifyObject',
           'BmpClipboardFormat', 'NetCDFRasterPropertyPage',
           'IAddLayersOperation', 'ISummarizeUI',
           'WMSSublayersPropertyPage', 'IAIAProperties',
           'EnhMetaFileClipboardFormat',
           'IMSMapLayerSourcePropertyPage', 'ITableProperty2',
           'TableProperty', 'esriMxCustomizationEvent',
           'AddQueryTableDialog', 'NetCDFFeaturePropertyPage',
           'TOCSelectionView', 'ColorCorrectionDockWin',
           'IdentifyWindow', 'MapServerLayerCachePropertyPage',
           'esriMxMarkerColor', 'IStartupDialog',
           'MapViewCommandsMenuItems', 'esriDCType',
           'WMSLayerStylePropertyPage', 'GpsPositionDialog',
           'MapInsetPropertyPage', 'SummarizeUI',
           'MapDocumentPropPage', 'MetadataViewWindow',
           'esriMxDlgOverflowLabels', 'ILayerEffectsEnvironment2',
           'IQueryAttributes', 'esriTinSlopeHisto',
           'ElementEditVerticesOperation', 'IMapInsetWindow',
           'RasterGxBrowserFactory', 'DataGraphWindow',
           'esriMxTextColor', 'MapViewCommandsContextAnalyzer',
