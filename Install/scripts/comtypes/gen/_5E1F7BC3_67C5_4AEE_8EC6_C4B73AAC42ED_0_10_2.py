# -*- coding: mbcs -*-
typelib_path = u'C:\\Program Files (x86)\\ArcGIS\\Desktop10.2\\com\\esriSystem.olb'
...
##        u"Obtains the machine's current local time reference. Set exactMatch to true to ensure exact retrieval of a customized machine's local time reference, or to false to obtain a pre-defined time reference, which is the closest match to the machine's current local t?\u0420?\x08?&"
...
__all__ = [ 'IRectHolder', 'esriLicenseExtensionCodeWorkflowManager',
           'esriTSFYearThruDayWithDash',
           'esriLicenseExtensionCodeNautical', 'IZipArchiveEx',
           'TimeExtent', 'esriSystemMessageCode_ErrorReadXml',
           'JSONEndOfArray', 'ILongArray', 'IObjectConstruct',
           'CoRESTOperation', 'esriAnimationDrawing', 'esriDTPolar',
           'IAngularConverter', 'IObjectUpdate',
           'esriSystemMessageCode_XMLTypeMappingFailed',
           'MESSAGESUPPORT_E_COULDNT_RESOLVE_PROXY',
           'esriLicenseExtensionCodeBathymetry', 'esriBSDTWCHAR',
           'esriProductCodePublisher', 'esriProductCodeDesigner',
           'esriJobMessageTypeProcessStart', 'esriLockMgrSchemaRead',
           'IServerUserInfo', 'esriTSFYearThruMinuteWithDash',
           'esriLicenseUnavailable', 'EnvironmentManager',
           'esriSquareMiles', 'esriUnitsLast', 'IJSONReader',
           ...
           'IZlibCompression', 'esriTSFYearThruSubSecond',
           'esriJobMessageTypeError', 'esriProductCodeNautical',
           ...
           'esriCustomScale', 'esriLicenseCheckedIn',
           ...
           'esriTimeStringFormat', 'JSONNull',
           'esriTSFYearThruSecondWithSlash', 'IEnumBSTR',
           'IExtensionManager', 'JSONStartOfObject',
           'IWebRequestHandler', 'IJobResults',
           ...
           'esriProductCodeAeronautical', 'esriByteSwapDataType',
           'esriLicenseExtensionCodeServerStandardEdition',
           'esriJobCancelling', 'esriLicenseExtensionCodeTIFFLZW',
           'esriAres', 'esriProductsInstalledServerJAVA',
           'esriTextureCompressionJPEG', 'esriPoints',
           'esriLicenseExtensionCodeVirtualEarthEng',
           'esriProductCodeIntelAgency', 'esriProductCodeFrance',
           'esriJobMessageType', 'esriProductCodeBusinessStandard',
           'esriAlignRight', 'IArray', 'esriDecimalDegrees', 'IUID',
           'IXMLStream',
           'esriLicenseExtensionCodeDataInteroperability',
           'XMLSerializer', 'IXMLSerialize', 'esriProductCodeItaly',
           'esriProductCodeBelgium', 'esriScaleFormat', 'XMLFlags',
           'ILatLonFormat', 'esriTimeLocaleFormat',
           'esriLicenseProductCode', 'IEnvironmentManager',
           'esriLicenseExtensionCodeVector',
           'esriLicenseExtensionCodeSchematics',
           'esriLicenseNotInitialized', 'esriTransportType',
           'esriJobTimedOut', 'esriCentimeters', 'esriDUGons',
           ...
           'esriProductsInstalledReader', 'IXMLNamespaces',
           ...
           'CurrencyFormat', 'IMessage', 'Time', 'IPersistVariant',
           'esriSystemMessageCode_SetResponseStreamVersion',
           'XMLNamespaces', 'ITrackCancel2', 'JSONArray',
           'esriJobDeleted', 'esriArcGISVersion90',
           'esriLicenseNotLicensed', 'esriArcGISVersion92',
           'esriArcGISVersion93', 'esriTSFYearThruMonthWithDash',
           'XMLStream', 'esriJobDeleting',
           'esriSystemMessageCodeEnum', 'WKSTimeDuration',
           'E_REQUIRES_SERVER_STANDARD_EDITION', 'IJSONObject',
           'esriAGSInternetMessageFormat', 'ITimeExtent',
           'IESRIScriptEngine', 'esriHectares',
           'esriLicenseUntrusted',
           'esriLicenseExtensionCode3DAnalyst', 'IVariantStreamIO',
           'IComponentCategoryManager', 'esriProductCodeDefenseUS',
           'SCRIPTENGINE_E_CANNOT_COCREATE_VBSCRIPT_CONTROL',
           'IFrequencyStatistics', 'IClassID', 'IRateFormat',
           'esriProductCodeVBAExtension', 'esriDrawMultipoint',
           'MESSAGESUPPORT_E_SSL_PEER_CERTIFICATE', 'WKSDateTime',
           'esriProductCodeVector',
           'esriLicenseExtensionCodeRuntimeStandard', 'IZipArchive',
           'MemoryBlobStream', 'esriLicenseExtensionCodeDefenseUS',
           ...
           'esriTSFYearThruMinute', 'IJITExtensionManager',
           'IJSONWriter2', 'E_NO_PRODUCT_LICENSE',
           'esriLicenseExtensionCodeServerAdvancedEdition',
           'IExtensionConfig', 'IFileNames', 'IEnumRESTOperation',
           'esriSystemMessageCode_CertFailed', 'TimeInstant',
           'esriLicenseExtensionCodePublisher', 'IJobMessage',
           'XML_SERIALIZE_E_CONVFAILED', 'esriHttpMethodGet',
           ...
           'ITestConnection', 'JSONWriter', 'IJobInfo',
           'IServerEnvironment2', 'IServerEnvironment3',
           'AngularConverter', 'MESSAGESUPPORT_E_AUTH_TOKEN_REQUIRED',
           'esriRoundNumberOfDecimals', 'IAngularConverter2',
           'ITimeZoneFactory', 'ITime',
           ...
           'esriJobWaiting', 'esriDPGeography',
           'esriTimeUnitsMinutes', 'esriLicenseExtensionCodeMrSID',
           'IJobFilter', 'AngleFormat', 'VariantStreamIO',
           'IXMLSerializeData', 'esriCaseAppearance',
           'esriSystemMessageCode_HTTPConnectionFailed',
           'IEnumVariantSimple', 'esriReadWrite', 'DoubleArray',
           'esriLicenseExtensionCodeArcMapServer', 'VarArray', 'ISet',
           'esriDrawMoveTo', 'Quantile',
           ...
           'esriProductCodeUnitedKingdom', 'JobMessages',
           'IObjectCopy', 'esriProductsInstalledDesktop',
           'IParentLicenseExtension', 'esriCaseAppearanceUnchanged',
           'esriLicenseExtensionCodeVideo',
           'esriTSFYearThruHourWithSlash', 'esriBSDTDOUBLE',
           'esriBSDTBYTE', 'ITimeDuration', 'IProgressor',
           'ICategoryFactory', 'esriProductCodeGeoStats',
           'IByteSwapStreamIO', 'MESSAGESUPPORT_E_AUTH_TOKEN_FAILURE',
           ...
           'esriTimeUnitsSeconds', 'esriLicenseAvailable',
           'WKSEnvelope', 'IJSONDeserializer', 'JSONTokenType',
           'esriDecimeters', 'esriJobMessageTypeProcessDefinition',
           'IProxyServerInfo2', 'esriSquareInches',
           'esriLicenseExtensionCodeDesigner', 'IScaleFormat',
           'WKSPoint', 'esriDrawPhase',
           ...
           'esriImperialScale', 'esriTimeUnits',
           ...
           'LicenseInfoEnum', 'IExtensionManagerAdmin', 'Set',
           'esriDrawPolyPolygon', 'esriTSFYearThruDayWithSlash',
           'AoInitialize', 'MESSAGESUPPORT_E_OPERATION_TIMEDOUT',
           'ICustomNumberFormat', 'IChildExtension', 'esriReadOnly',
           'esriLicenseExtensionCodeDefense',
           'esriTextureCompressionNever',
           'esriProductCodeDefenseINTL', 'IBlobStream',
           'esriUnknownAreaUnits', 'ICheckProgressor', 'IJSONReader2',
           'esriDTQuadrantBearing', 'IObjectStream',
           'esriDrawBeginPath', 'IXMLVersionSupport',
           'XML_SERIALIZE_E_UNKNOWN', 'IClone', 'esriJobCancelled',
           'esriBSDTchar', 'esriProductCodeHighways',
           'FractionFormat', 'esriJobSubmitted', 'ArcGISLocale',
           'ESRILicenseInfo', 'esriRoundingOptionEnum',
           'TimeZoneTransitionTime', 'xmlSerializeError', 'StrArray',
           'IDirectionFormat', 'ZipArchive', 'esriDPAnnotation',
           'esriHttpMethodDelete', 'IXMLObjectElement', 'esriFeet',
           'esriAreaUnitsLast', 'esriDrawRectangle',
           'MESSAGESUPPORT_E_PROXY_GATEWAY_ERROR',
           'esriProductCodeDenmark', 'ITimeZoneInfo', 'esriBSDTbool',
           ...
           'esriProductCodeBingMaps', 'DefinedInterval',
           'IServerEnvironment', 'esriProductCode', 'esriTLFLongTime',
           'esriProductCodePortugal', 'esriInches',
           'esriArcGISVersionCurrent', 'esriProductCodeImageExt',
           ...
           'MESSAGESUPPORT_E_GET_TOKEN_FAILED', 'TimeZoneRule',
           'esriProductCodeProductionMapping', 'IRESTRequestHandler',
           'esriLicenseExtensionCodeDefenseINTL', '_WKSPoint',
           'esriLicenseExtensionCodeRuntimeAdvanced',
           'AoAuthorizeLicense', 'esriJobExecuting', 'JSONBoolean',
           'esriProductCodeMrSID', 'esriProductCodeSweden',
           'esriITFYearThruHour', 'esriDrawArcCCW', 'OLE_HANDLE',
           'esriSystemMessageCode_AuthFailed', 'CoRESTResource',
           'IClassify', 'MESSAGESUPPORT_E_NOT_ACCEPTABLE',
           'esriSystemMessageCode_BinaryResponseSent',
           'esriProductCodeRuntimeAdvanced', 'SSLInfo', '_WKSPointZ',
           'ILatLonFormat2', 'esriProductCodeWorkflowManager',
           'esriDrawCircle', 'MESSAGESUPPORT_E_REQUEST_TOLARGE',
           'ITime2', 'esriSystemMessageCode_ErrorLoadBinaryStream',
           'esriMeters', 'IClassifyMinMax', 'IGenerateStatistics',
           'IJobRegistry', 'esriProductCodeTIN', 'IStream',
           'esriKilometers', 'IAMFWriter',
           'esriDrawPolyPolygonNoBorder',
           'MESSAGESUPPORT_E_COULDNT_CONNECT', 'SystemHelper',
           'esriHttpMethodOptions', 'esriLicenseFailure',
           'IEnumNameEdit', 'esriAnimationLast', 'esriESEnabled',
           'BaseStatistics', 'esriBSDTunsignedint',
           'esriProductCodeNetwork', 'ISSLInfo', 'IUnitConverter',
           'IGlobeCompression', 'JSONStartOfArray',
           ...
           'esriTimeUnitsMonths', 'IJobTracker', 'esriMiles',
           ...
           'esriProductCodeStandard', 'esriTimeUnitsUnknown',
           'IComponentCategoryInfo', 'esriHttpMethodPut',
           'esriProductCodeServerAdvancedEdition', 'INumberFormat',
           ...
           'esriLicenseExtensionCodeBingMaps', 'esriDrawPolygon',
           'CustomNumberFormat', 'esriProductCodeNetherlands',
           'IXMLFlags', 'XMLTypeMapper', 'ProxyServerInfo',
           'IMemoryBlobStream', 'IFile', 'esriProductCodeBingMapsEng',
           'LocaleInfo', 'esriProductCodeDefense',
           'esriLicenseExtensionCodeAGINSPIRE', 'ITextureCompression',
           'esriProductCodeStreetMap', 'IArcGISLocale',
           'esriTSFYearThruSecond', 'ILocaleInfo', 'IXMLWriter',
           'esriProductCodeCOGO', 'esriTSFYearThruSubSecondWithSlash',
           'esriBSDTULONGLONG', 'IStatisticsResults',
           'esriTSFYearThruMonth', 'IXMLReader', 'ILog',
           'IXMLSerializeData2', 'esriNumericAlignmentEnum',
           'IEnumRESTResource', 'esriDUDegreesMinutesSeconds',
           'ITimeValue', 'esriSpecifyFractionDenominator',
           'esriDrawEndPath', 'XMLAttributes', 'IRequestHandler2',
           'IFileName', 'esriSquareKilometers', 'IParseNameString',
           'ITimeRelationalOperator', 'esriLockMgrEdit',
           'esriJobSucceeded', 'JSONValueDelimiter', 'esriYards',
           'ScientificFormat',
           'esriLicenseExtensionCodeMappingAgency', 'ITimeReference',
           'LatLonFormat', 'esriTimeUnitsCenturies', 'IXMLWriter2',
           'esriArcGISVersion101', 'esriProductCodeVirtualEarthEng',
           'JSONString', 'esriLockMgrSchemaWrite',
           'esriProductsInstalledEngineRuntime', 'IEnumUID',
           'JSONObject', 'esriSystemMessageCode_ErrorWriteXml',
           'IErrorInfo', 'ExtensionManager', 'InputDeviceManager',
           'ScaleFormat', 'E_NOTLICENSED',
           'esriLicenseServerEditionStandard', 'ILogSupport',
           'esriLicenseExtensionCodeAirports',
           'esriProductCodeServerEnterprise',
           'IScientificNumberFormat', 'esriDrawArcCW',
           'IAoInitialize', 'esriSpecifyFractionDigits',
           'esriHttpMethodPost', 'esriBSDTBOOLU', 'JSONEndOfObject',
           ...
           'esriProductCodeGermany', 'esriProductCodeBasic', 'UID',
           'IExtensionAccelerators', 'ITimeZoneFactory2',
           'IPropertySet', 'esriProductCodeAGINSPIRE',
           'IDeviationInterval', 'messageSupportError',
           'esriJobStatus', 'esriSquareFeet',
           'esriProductCodeArcPress', 'ITimeOffsetOperator',
           'esriDUGradians', 'esriLicenseStatus',
           'esriProductCodeArcMapServer',
           'esriLicenseServerEditionBasic', 'esriNauticalMiles',
           'PropertySetArray', 'IAngleFormat', 'IAutoExtension',
           'esriLockMgrRead', 'JobMessage',
           ...
           '_esriPointAttributesEx', 'IProxyServerInfo',
           ...
           'esriFractionOptionEnum', 'esriProductCodeVirtualEarth',
           ...
           'IDoubleArray', 'esriTimeUnitsMilliseconds', 'XMLReader',
           'IJob', '_esriSegmentModifier', 'Message',
           'JSONPropertyValueDelimiter', 'IXMLTypeMapper',
           'esriTLFShortTime', 'esriArcGISVersion',
           'IExternalDeserializer', 'esriProductCodeBathymetry',
           'esriSystemMessageCode_BinaryRequestReceived',
           'esriDrawOp', 'PercentageFormat', 'esriProductCodeGrid',
           'IJSONWriter', 'IRequestHandler', 'esriArcGISVersion83',
           'CategoryFactory', 'esriSquareMillimeters',
           'esriDirectionType', 'esriAGSInternetMessageFormatSoap',
           'SCRIPTENGINE_E_CANNOT_COCREATE_JSCRIPT_CONTROL',
           'esriBSDTGUID', 'esriTimeRelation', 'IName',
           'esriProductCodeAustria', 'ITimeZoneRule', '_WKSEnvelopeZ',
           'TimeDuration', 'esriLicenseExtensionCodeArcScan',
           'esriLicenseServerEdition', 'ByteSwapStreamIO',
           'IESRILicenseInfo', 'IXMLSerializer', 'IXMLAttributes',
           'IAuthorizeLicense',
           'esriSystemMessageCode_StringResponseSent',
           'esriESUnavailable', 'esriProductCodeReaderPro',
           'esriSystemMessageCode_Debug', '_WKSTimeDuration',
           'esriSquareDecimeters', 'IRESTOperation', 'esriBSDTLONG',
           'esriJobMessageTypeEmpty', 'IJSONArray', '_WKSDateTime',
           'esriJobFailed', 'esriTLFShortDate', 'esriTSFYearOnly',
