# -*- coding: mbcs -*-
typelib_path = u'C:\\Program Files (x86)\\ArcGIS\\Desktop10.2\\com\\esriDisplay.olb'
...
__all__ = [ 'esriDrawIgnore3DMaterial', 'esriResampleRatio',
           ...
           'GeometricEffectMove', 'esriEnvelopeConstraintsSquare',
           'esriClipBasicClipping', 'esriROPXOrPen', 'IRubberBand2',
           'esriSFSHorizontal', 'IScreenDisplayZoom',
           'esriGADonutWidth', 'esriTVACenter', 'esriLJSMitre',
           'IEnumColors', 'IMarkerSymbol', 'esriGAOffsetCurveMethod',
           'esriGAOnVerticesControlPoints',
           'esriGADecorationFlipFirst', 'esriGAAlongLineStep',
           'IRasterOutputSettings', 'IDotDensityMasking',
           'esriLineJoinStyle', 'esriOutlineType',
           'REP_E_EMPTY_ENUM_ATTRIBUTE', 'PointTracker',
           'esriDashAttributeTypeFillsAndGaps', 'ITextSymbol',
           'FontSize', 'esriGACutCurveInvert', 'esriGFSBuffered',
           'esriTHACenter', 'esriGARegularPolygonAngle',
           'ISimpleTextSymbol', 'esriNoScreenCache',
           'esriGDIComment_End_PageLayout', 'ILineDecorationElement',
           'RepresentationRule', 'IColorRampElements',
           'esriDraw3DTransparent', 'GeometricEffectAddControlPoints',
           'PresetColorRamp', 'esriDSymbolText',
           'INewBezierCurveFeedback', 'ITextParserSupport',
           'esriGATaperedPolygonLength', 'esriROPBlack',
           'GeometricEffectOffsetTangent', 'MoveLineFeedback',
           'esriDynamicDrawPhase',
           'esriGDIComment_Begin_Feature_Attribute',
           'MarkerPlacementRandomAlongLine', 'esriMSNone',
           'IDisplay3D', 'esriCIELabAlgorithm', 'esriTCLowercase',
           'esriGADonutSimple', 'IScreenDisplay', 'esriTextDirection',
           'ITextMargins', 'IRepresentationRule2', 'LineFillSymbol',
           'IAnchorPoint', 'IFontAttribute', 'esriDisplayCacheFlags',
           ...
           'esriGAVariableAlongLineMethod', 'esriSimpleMarkerStyle',
           'SimpleLineSymbol', 'esriGAAtExtremitiesOffset',
           'esriGradientFillStyle', 'IDynamicGlyph',
           'IBasicLineSymbol', 'NewEnvelopeFeedback', 'IEnumSymbol',
           'esriGAInsidePolygonShiftOddRows', 'IScreenDisplay2',
           ...
           'esriMarkerFillStyle', 'GeometricEffectDonut', 'IBold',
           'esriGAOffsetTangentOffset', 'IMoveImageFeedback',
           'RubberPoint', 'IDynamicDisplay2',
           'MarkerPlacementRandomInPolygon', 'IMarkerLineSymbol',
           'esriGDICommentSetCmykColor', 'IEnumConnections', 'IDraw',
           'IHashLineSymbol', 'esriGAJogPosition', 'IFontSize',
           'esriROPMaskNotPen', 'AnchorPoint', 'MoveBitmapFeedback',
           'RubberEnvelope', 'esriSMSDiamond',
           'NewBezierCurveFeedback', 'esriTrackerDominant',
           'esriGAEnclosingPolygonMethod', 'esriScreenCache',
           ...
           'PolygonTracker', 'esriGDICommentBeginGroup',
           'IEditInteraction', 'esriAttributeTypeDouble',
           'esriGAExtensionOrigin', 'ServerStyleGallery',
           'esriTrackerActive', 'esriLCSCustom', 'NewPolygonFeedback',
           'esriLCSThreePoint', 'IMarkerBackground',
           'esriGARandomAlongLineControlPoints', 'esriGARotateAngle',
           'GraphicAttributeBooleanType', 'ITextPath2',
           'LocationInterior', 'GeometricEffectWave',
           ...
           'IDynamicCompoundMarker', 'esriDSymbolMarker',
           'IDynamicScreenDisplay', 'esriDynamicSelectionMode',
           'IRepresentationGraphics', 'esriDSymbolFill',
           'IStyleImporter', 'esriMoveTextConstraintsRight',
           'esriSLSDot', 'esriGraphicAttribute',
           'esriTexInterpolBilinear', 'esriGDICommentBeginPageLayout',
           'RubberPolygon', 'IDynamicDrawing',
           'esriDisplayCacheRequiresBackground', 'esriTrackerNormal',
           'ITextBackground2', 'esriPSOVectorize',
           'esriGAGradientPatternAngle', 'esriGDICommentBeginTextEx',
           'esriGDICommentFillWithPattern',
           'esriGAGradientPatternStyle', 'esriDraw3DImmediate',
           'ISymbologyEnvironment',
           'esriGDICommentPlayEnhMetafileEnd',
           'MoveTextAlongShapeFeedback', 'esriTexInterpolNearest',
           'esriGARandomAlongLinePosition', 'CancelTracker',
           'esriDynamicGlyphType', 'IBasicFillSymbol',
           'esriDashAttributeTypeOnlyGaps',
           'esriGDIComment_Mask_Layer', 'tagCONNECTDATA',
           'ITimeDisplay2', 'IBalloonCallout', 'ISymbol',
           'esriEnvelopeConstraints', 'esriGAInsidePolygonXStep',
           'esriLJSRound', 'esriIPictureEMF', 'esriTrackerLocation',
           'MultiLayerFillSymbol', 'MonitorSettings',
           ...
           'MarkerTextBackground', 'IGraphicsOutline',
           'IRepresentationMarker', 'esriSFSCross',
           'BezierMovePointFeedback', 'esriROPNotMaskPen',
           'esriBCSRectangle', 'esriROPMergePenNot',
           'esriEnvelopeEdgeTopLeft', 'IStyleGalleryItem',
           'ISymbolCollection2', 'esriOutlineBox',
           'GeometricEffectSuppress', 'esriGALinePatternStep',
           'esriPSORasterize', 'IDisplayTransformationAdmin',
           'esriGAGradientPatternInterval', 'esriIPictureType',
           'esriGAMarkerRotateClockwise', 'ICieLabConversion',
           'IOutputRasterSettings', 'esriGAAtExtremitiesAngleToLine',
           'esriLineCapStyle', 'GraphicAttributeDoubleType',
           'LineStroke', 'esriLCSCircularCW', 'esriOutlineNoOption',
           'EnvelopeTracker', 'esriGAGradientPatternPercent',
           'MarkerPlacementDecoration', 'esriGAInsidePolygonYStep',
           'esriGDICommentBeginMap', 'NewTextFeedback',
           'MovePolygonFeedback', 'IStyleGalleryStorageAdmin',
           'IDisplayName', 'IMoveCurvedTextFeedback',
           'esriClippingMethod', 'IPointCollectionTracker',
           'RepresentationRuleItem', 'esriTHARight',
           'esriGATaperedPolygonFromWidth', 'esriDSRAScreen',
           'esriUserScaleSnapping', 'IDotDensityFillSymbol',
           'IStyleGalleryStorage', 'IMovePolygonFeedback',
           'IMarkerFillSymbol', 'esriGAAlongLineControlPoints',
           'esriLCSCircularCCW', 'esriGADonutMethod',
           'esriGDIComment_Mask_Layer_Before_Clipping',
           'SimpleTextParser', 'esriGADashPattern', 'HsvColor',
           'ITimeDisplayEvents', 'esriGFSCircular',
           'esriGAAtExtremitiesType',
           'REP_E_GEOMETRY_TYPE_NOT_SUPPORTED',
           'SimpleLineDecorationElement', 'IClippingMethod',
           'IMultiLayerLineSymbol', 'GraphicAttributeMarkerType',
           'esriDDPCompiled', 'esriDynamicSymbolRotationAlignment',
           'GeometricEffectSmooth', 'esriEnvelopeEdgeBottomMiddle',
           'esriGAMoveYOffset', 'esriMarkerPlacementAttributes',
           'esriGALinePatternWidth', 'IReferenceLineSymbol',
           'IChartSymbol', 'MoveImageFeedback', 'esriOrientMode',
           'esriGDICommentEndLayer', 'CmykColor', 'ILineCallout',
           'esriGAAlongLineEndings', 'MarkerPlacementPolygonCenter',
           'esriGARandomInsidePolygonClipping',
           'esriRepresentationDrawingError',
           'esriAttributeTypeBoolean', 'esriAttributeTypeText',
           'ISymbolCollection', 'IDotDensityFillSymbol2',
           'BasicFillSymbol', 'FontColor', 'IGraphicAttributeType',
           'esriLCSRound', 'SimpleMarkerSymbol', 'ILayerVisible',
           'IOrientInteraction', 'IVertexFeedback',
           'esriDraw3DSilent', 'ITimeDisplay',
           'esriGAPolygonCenterYOffset',
           'GlobalScreenDisplaySettings', 'IOverposterTextPath',
           'IDynamicDisplay', 'IDynamicMapEvents',
           'ICharacterOrientation', 'esriGDIComment_Begin_Map',
           'MarkerPlacementOnVertices', 'esriDraw3DGeography',
           'IMoveInteraction', 'IColor', 'GraphicAttributeTextType',
           'MoveTextFeedback', 'IMoveEnvelopeFeedback',
           'ILineProperties', 'IResizeTextFeedback',
           'IDisplayTransformationScales',
           'IPictureSymbolEnvironment', 'esriROPWhite',
           'esriGAMoveXOffset', 'IMoveTextFeedback', 'ICmykColor',
           'IBezierDisplayFeedback', 'esriGARandomAlongLineRandom',
           'esriScaleSnapping', 'IWordBoundaries',
           'esriEnvelopeConstraintsNone', 'TransparencyDisplayFilter',
           'esriGASimplifyTolerance', 'esriTextVerticalAlignment',
           'esriGAOnLineRelativeTo', 'IDynamicDrawScreen',
           'ICalloutFeedback2', 'IPictureLineSymbol',
           'esriGAVariableAlongLineMinZoom', 'IDisplayFilterManager',
           'IGraphicAttributeDashType', 'INewCircleFeedback',
           'esriGAScaleYFactor', 'PictureLineSymbol',
           'MarkerPlacementOnLine', 'esriGAOffsetTangentMethod',
           'IRasterPicture', 'IHsvColor', 'IFormattedTextSymbol',
           'esriStandardScaleSnapping', 'esriLabLChAlgorithm',
           'esriGDIComment_Begin_Feature', 'SimpleFillSymbol',
           'esriSFSDiagonalCross', 'BasicMarkerSymbol',
           'INewCircleFeedback2', 'esriROPNOP',
           'IMultiLayerMarkerSymbol',
           'esriGARandomInsidePolygonXOffset', 'esriGAMarkerAngle',
           'esriGAVariableAlongLineControlPoints', 'IDisplayAdmin2',
           'esriGAVariableAlongLineOffset', 'esriLCSUnderline',
           'IlluminationProps', 'esriOMPerpendicular',
           'IStyleGalleryClass', 'NewArcFeedback', 'ILineFillSymbol',
           'esriIPicturePNG', 'esriGASuppressSuppress',
           'FontAttributeItalic', 'GeometricEffectBuffer',
           'esriTPSuperscript', 'esriSimpleLineStyle',
           'IEnumConnectionPoints', 'esriTCNormal',
           'esriGADecorationFlipAll', 'esriTCAllCaps',
           'IEnumStyleGalleryItem', 'MoveEnvelopeFeedback',
           'IResizeEnvelopeFeedback',
           'esriGDIComment_FillWithPattern', 'IIlluminationProps',
           'IFillProperties', 'esriSFSSolid', 'esriSFSVertical',
           'esriGDICommentBeginLayer', 'GradientPattern',
           'CharacterMarkerSymbol', 'esriGAWaveWidth',
           'GroupFeedback', 'esriAllScreenCaches',
           'ModifySegmentFeedback', 'MarkerPlacementAlongLine',
           'esriMFSGrid', 'LocationBottomMiddle', 'esriDDPImmediate',
           'MarkerPlacementAtExtremities',
           ...
           'EnumServerStyleGalleryItem', 'ISimpleMarkerSymbol',
           'esriGDIComment_PlayEnhMetafileEnd',
           'esriGAVariableAlongLineSeed', 'SimpleTextPath',
           'GeometricEffectEnclosingPolygon', 'MarkerFillSymbol',
           'NewLineFeedback', 'IMultiPartColorRamp',
           'INewRectangleFeedback', 'esriGAJogAngle',
           'IGeometricEffect', 'IMarkerMask',
           'esriGAGradientPatternAlgorithm', 'MovePointFeedback',
           'INewMultiPointFeedback', 'esriGDIComment_Begin_Layer',
           'esriGDICommentMaskLayerBeforeClipping',
           'esriColorRampAlgorithm', 'ISymbolIdentifier',
           'GeometricEffectOffset', 'esriDSMBeforeDynamicDraw',
           'esriTDHorizontal', 'IOffsetInteraction',
           'IDynamicGlyphFactory', 'IMultiLayerFillSymbol',
           'IStretchLineFeedback', 'esriOutlineExact',
           'LineMovePointFeedback', 'esriGARandomAlongLineEndings',
           'IResizeInteraction', 'GrayColor', 'CalloutFeedback',
           'IScaleTracker', 'ISymbologyEnvironment2',
           'SolidColorPattern', 'esriGALinePatternOffset',
           'esriIPictureGIF', 'esriEnvelopeConstraintsAspect',
           'esriGAOnPointYOffset', 'esriGAVariableAlongLineStep',
           'LocationMiddleRight', 'esriTVABottom',
           'esriSimpleFillStyle', 'esriGraphicAttributeType',
           'NewEllipseFeedback', 'esriGDICommentEndPageLayout',
           'esriDisplayCachePrivate', 'esriEnvelopeEdgeTopMiddle',
           'IAppDisplay', 'Template', 'IRubberBand',
           'LocationBottomRight', 'IMask', 'esriSFSForwardDiagonal',
           'esriLCSSquare', 'HlsColor', 'GeometricEffectDash',
           'ILineSymbol', 'IBasicMarkerSymbol', 'esriGABufferSize',
           'esriSFSHollow', 'WordTextPath', 'esriDGlyphText',
           'IQueryGeometry', 'LocationTopLeft',
           'MarkerPlacementVariableAlongLine',
           'esriGAAlongLinePosition', 'esriDGlyphLine',
           'IPieChartSymbol', 'esriGDIComment_End_Map',
           'esriSLSSolid', 'IGraphicAttributeEnumType', 'esriSLSDash',
           'IFontColor', 'esriGFSRectangular', 'IPictureFillSymbol',
           'IEnumScreenDisplay', 'esriGADecorationAngleToLine',
           'NewMultiPointFeedback', 'CieLabConversion',
           'IReshapeFeedback2', 'esriGADashOffsetAtEnd',
           'CartographicLineSymbol', 'IRotateTracker',
           'ReshapeFeedback2', 'esriEnvelopeEdgeMiddleRight',
           'esriLineConstraintsNone', 'IDynamicGlyphFactory2',
           'IRandomColorRamp', 'REP_E_MAP_CONTEXT_NOT_INITIALIZED',
           'IFillPattern', 'IReshapeFeedback', 'esriGARadialAngle',
           'IUpdateLegendInfo', 'SimpleDisplay',
           'esriGDIComment_Begin_Group', 'SimpleLineCallout',
           'esriTrackerStyle', 'esriDSMLayers',
           'MarkerPlacementOnPoint', 'esriGDICommentEndText',
           'MapContext', 'IPictureMarkerSymbol', 'LinePattern',
           'esriDashAttributeType', 'esriGDICommentFeatureAttribute',
           'esriSLSInsideFrame', 'RotateTextFeedback',
           'IRepresentationRuleItem', 'esriTPSubscript',
           'esriDGlyphFill', 'esriAttributeTypeDash',
           'IRotateTextFeedback', 'esriGDICommentBeginFeature',
           'IPostScriptColor', 'GeometricEffectReverse',
           'esriOutlineOrientedBox', 'esriROPNotCopyPen',
           'IStackedChartSymbol', 'esriEnvelopeEdgeBottomLeft',
           'DisplayTransformation', 'IMoveLineFeedback',
           'esriGADecorationEndGap', 'esriGAInsidePolygonGridAngle',
           'esriTHALeft', 'ISimpleLineCallout', 'esriBCSOval',
           'esriGALinePatternAngle', 'BasicRasterPicture',
           'IHlsColor', 'esriGARandomAlongLineSeed',
           'IFontsInSymbolsEnvironment', 'IGeodeticLineFeedback',
           'MultiLayerLineSymbol', 'esriSFSBackwardDiagonal',
           'ISymbolArray', 'esriGAVariableAlongLineMaxZoom',
           'IConnectionPointContainer', 'ModifyCircularArcFeedback',
           ...
           'IFieldOverride', 'ColorRampElements',
           'esriGAOnVerticesRegularVertices',
           'RepresentationGraphics', 'esriLineConstraints',
           'esriSLSDashDotDot', 'INewTextFeedback', 'ScreenDisplay',
           'MovePointFeedback2', 'esriGACutCurveEnd', 'esriTVATop',
           'esriGAOnVerticesEndPoints', 'esriDraw3DMode',
           'IReferenceFillSymbol', 'BarChartSymbol',
           'esriGDICommentEndGroup', 'LocationMiddleLeft',
           'IDisplayFeedback2', 'esriGAControlPointsTolerance',
           'esriDMDPDynamicLayers', 'RandomColorRamp',
           'VertexFeedback', 'esriGAAlongLineAngleToLine',
           ...
           'esriTPNormal', 'esriTransformSize',
           'esriGDIComment_Set_Text_Extra',
           'IScreenDisplayOverlaysCallback', 'esriSMSSquare',
           'ICallout', 'esriGDIFeatureHyperlink',
           'MarkerPlacementInsidePolygon',
           'GraphicAttributeColorType', 'esriGDIComment_Begin_Text',
           'FontAttributeUnderline', 'IWordTextPath',
           'ArrowMarkerSymbol', 'IRepresentationRuleInit',
           'esriGAVariableAlongLineEndings',
           'esriGADecorationBeginGap', 'esriDraw3DGraphics',
           ...
           'IScreenCacheManager', 'ITextPath', 'IMoveBitmapFeedback',
           'PieChartSymbol', 'IDimDisplayFilter',
           'esriDisplayFilterFlags', 'IScreenDisplayOverlays',
           'esriGACutCurveBegin', 'esriDSRANorth',
           'GeometricEffectExtension', 'esriDMDPSelection',
           'esriDSMDynamicDrawing', 'IMonitorSettings',
           'esriOutlineConvex', 'INewEnvelopeFeedback2',
           'esriGAMarkerSize', 'PictureFillSymbol',
           'esriGAStrokeColor', 'esriGAPolygonCenterMethod',
           'esriGDIComment_Set_Cmyk_Color', 'LocationTopMiddle',
           'esriDraw3DOpaque', 'esriAttributeTypeSize',
           'IDisplayTransformation', 'ICartographicMarkerSymbol',
           'esriOutlineOption', 'esriGADashEndings',
           ...
           'AlgorithmicColorRamp', 'IPolygonMovePointFeedback',
           'esriGDICommentEndFeatureAttribute',
           'esriGAPolygonCenterXOffset', 'esriGAStrokeCaps',
           'IBasicSymbol', 'esriTCSmallCaps', 'TextSymbol',
           'esriTHAFull', 'GradientFillSymbol', 'INewArcFeedback',
           'esriROPMergePen', 'RubberLine', 'ServerStyleGalleryItem',
           'GeometricEffectTaperedPolygon', 'esriGDIComment_End_Text',
           'IDisplayEvents', 'PolygonMovePointFeedback', 'IGrayColor',
           'esriROPMergeNotPen', 'IMarkerTextBackground',
           'StretchLineFeedback', 'esriIPictureJPG', 'esriGFSLinear',
           'EngineRotateTracker', 'GraphicAttributeEnumType',
           'IRgbColor', 'esriGARandomAlongLineOffsetAtEnd',
           'BezierTextPath', 'LocationTopRight', 'IBarChartSymbol',
           'esriDSymbolLine', 'esriEnvelopeEdgeMiddleLeft',
           'MarkerLineSymbol', 'esriGAOnVerticesAngleToLine',
           'esriGAOnLineAngleToLine', 'ISimpleLineSymbol',
           'IDynamicCompoundMarker2', 'ILayerTags',
           'esriRasterOutputBest', 'esriDGlyphMarker',
           ...
           'IMoveTextAlongShapeFeedback',
           'esriGDIComment_PlayEnhMetafileBegin', 'GeometryDraw',
           'esriAttributeTypeColor', 'esriGASmoothTolerance',
           'IUnderline', 'esriTextCase',
           'esriGATaperedPolygonToWidth', 'esriRasterOpCode',
           'esriGDICommentEndFeature', 'ColorElements',
           'esriAttributeTypeInteger', 'NewCircleFeedback',
           'esriGAAlongLineOffsetAtEnd', 'esriEnvelopeEdge',
           'ISelectionTracker', 'esriPSORasterizeIfRasterData',
           'GraphicAttributeAngleType', 'IPresetColorRamp',
           'esriDisplayCacheNoFlags', 'esriArrowMarkerStyle',
           'esriTexInterpolMipMap', 'ISymbol3D',
           'esriTransformToDevice', 'esriGAWaveStyle',
           'IMovePointFeedback', 'esriLineCalloutStyle',
           'ISimpleFillSymbol', 'IItalic', 'esriGAJogLength',
           'GeometricEffectSimplify', 'esriRasterOutputDraft',
           'ReshapeFeedback', 'esriGAOffsetCurveOption',
           'IOutputContext', 'esriAttributeTypeAngle',
           'esriGDICommentPlayEnhMetafileBegin', 'IMarkerPlacement',
           'esriGAArrowType', 'ICharacterMarkerSymbol',
           'esriLCSMidpoint', 'IModifySegmentFeedback',
           'IDelayEvents', 'esriMoveTextConstraintsLeft',
           'esriDSMAfterDynamicDraw', 'esriClipRemoveBoxOutside',
           'ITemplate', 'LineTracker', 'IScreenInvalidate',
           'IScreenDisplayBasemap', 'esriGAScaleXFactor',
           'esriROPMaskPen', 'esriGAWaveSeed', 'ILineDecoration',
           'IDisplayFiltersControl', 'esriMFSRandom',
           'esriGDIComments', 'IModifyCircularArcFeedback',
           'ISimpleLineDecorationElement', 'esriDynamicMapDrawPhase',
           'esriTransformPosition', 'IMoveGeometryFeedback',
           'esriTextPosition', 'INewLineFeedback',
           'esriGAOffsetCurveSimple', 'FontName', 'CalloutTracker',
           'esriDisplayTransformationEnum',
           'IMarkerBackgroundSupport', 'IMapContext',
           'IDisplayFeedback', 'GeometricEffectCut', 'esriSFSNull',
           'ILineMovePointFeedback',
           'esriGDICommentBeginFeatureAttribute',
           'RepresentationMarker', 'esriSLSNull',
           'IGradientFillSymbol', 'RubberCircle',
           'GeometricEffectJog', 'esriGAInsidePolygonYOffset',
           'esriGALinePatternColor', 'GraphicAttributeSizeType',
           ...
           'IDisplay', 'IColorElements',
           'esriGeometricEffectAttributes',
           'esriGAInsidePolygonClipping', 'ITextBackground',
           'esriROPCopyPen', 'IAlgorithmicColorRamp',
           'IGraphicAttributes2', 'IStyleGalleryClass2',
           'esriDFExternalCache', 'esriSMSCross', 'esriLJSBevel',
           'esriGDIComment_Feature_URL', 'esriGARadialLength',
           'esriGDIComment_End_Group',
           'esriLineConstraintsHorizontal', 'esriTDVertical',
           'esriEnvelopeEdgeBottomRight',
           'esriGDIComment_End_Feature', 'esriLCSButt',
           'HashLineSymbol', 'esriGDICommentEndMap',
           'IGeometricEffects', 'esriGAOffsetCurveCount',
           ...
           'IMarginProperties', 'esriRasterOutputNormal',
           'esriGAExtensionDeflection', 'esriClipNoClipping',
           'esriGARegularPolygonRadius', 'GeometricEffectScale',
           'ICalloutFeedback', 'esriSMSCircle',
           'esriGDIComment_Feature_Attribute', 'MoveGeometryFeedback',
           'esriSMSX', 'esriDraw3DSelection',
           'IDynamicSymbolProperties2', 'ITextDrawSupport',
           'I3DChartSymbol', 'esriGDICommentMaskLayer', 'LineCallout',
           'IDrawingOutline', 'esriGAOnLinePosition',
           'INewEnvelopeFeedback', 'esriAttributeTypeEnum',
           'IGeometryDraw', 'esriGDICommentBeginText', 'RgbColor',
           'BalloonCallout', 'IDisplayAdmin', 'esriDSMNone',
           'esriGADecorationNumberOfPositions', 'esriScreenRecording',
           'MultiPartColorRamp', 'IMoveImageFeedback2']
